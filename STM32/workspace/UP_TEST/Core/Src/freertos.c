...
void GAIT_Task(void const * argument)
{
  ...
  for(;;)
  {
	  if(motor_setdes(motor[1], test_trajectory[test_cnt]) == 1)	DmaPrintf("motor1 limits\n");
	  test_cnt ++;
	  if(test_cnt == 10){
	  		test_cnt = 0;
	  }
...
//	  if(stand_flag){
//		  if(motor_setdes(motor[1], stand_trajectory[tra_cnt][0]) == 1)	DmaPrintf("motor1 limits\n");
//		  if(motor_setdes(motor[2], stand_trajectory[tra_cnt][1]) == 1)	DmaPrintf("motor2 limits\n");
//		  tra_cnt ++;
//		  if(tra_cnt == 100){
//			  tra_cnt = 0;
//			  stand_flag = 0;
...
//	  }
//	  if(swing_flag){
//		  if(motor_setdes(motor[1], swing_trajectory[tra_cnt][0]) == 1)	DmaPrintf("motor1 limits\n");
//		  if(motor_setdes(motor[2], swing_trajectory[tra_cnt][1]) == 1)	DmaPrintf("motor2 limits\n");
//		  tra_cnt ++;
//		  if(tra_cnt == 100){
//			  tra_cnt = 0;
//			  stand_flag = 1;
