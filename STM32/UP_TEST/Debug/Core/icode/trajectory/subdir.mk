...
Core/icode/trajectory/%.o Core/icode/trajectory/%.su Core/icode/trajectory/%.cyclo: ../Core/icode/trajectory/%.c Core/icode/trajectory/subdir.mk
...
clean-Core-2f-icode-2f-trajectory:
	-$(RM) ./Core/icode/trajectory/trajectory.cyclo ./Core/icode/trajectory/trajectory.d ./Core/icode/trajectory/trajectory.o ./Core/icode/trajectory/trajectory.su
